...
All notable changes to the CeloHT Brand Repository are documented here.
...
### Added
- Initial public release of the CeloHT Brand Repository
- Core governance documents: `README.md`, `LICENSE`, `CONTRIBUTING.md`, `CODE_OF_CONDUCT.md`, `SECURITY.md`
- Foundational identity documents: `VISION.md`, `MISSION.md`, `VALUES.md`, `BRAND_GUIDE.md`
- `LOGO_GUIDELINES.md` - full usage rules, do's/don'ts, disclaimer requirements
- `COLOR_SYSTEM.md` - full palette with HEX/RGB/HSL/CMYK values and WCAG 2.2 contrast data
