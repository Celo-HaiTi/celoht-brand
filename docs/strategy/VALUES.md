...
These values govern every decision in this repository and in the broader CeloHT project - from a single word choice in a document to how the logo may be used.

## 1. Open Source
Everything CeloHT builds - code, documentation, brand assets, governance process - is public by default and licensed for reuse, because closed systems can't earn the trust financial inclusion requires.
...
## 5. Education
We teach before we ask people to act. Educational content is a permanent commitment, not a funnel toward a product.
...
## 9. Global Impact, Local Roots
CeloHT is built for Haiti first, in Haitian Creole first - and built openly enough that its model can inform financial inclusion efforts elsewhere, without losing its local grounding.

## 10. Long-Term Trust
Every choice - visual, technical, or governance-related - is made for durability over ten years, not for a single funding cycle or trend.
